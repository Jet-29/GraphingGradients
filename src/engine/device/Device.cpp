...
namespace Spyder {
	...
	[[maybe_unused]] void Device::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height, uint32_t layerCount) {
		VkCommandBuffer commandBuffer = beginSingleTimeCommands();
	...
	void Device::createLogicalDevice() {
		...
		// might not really be necessary any more because device specific validation layers
